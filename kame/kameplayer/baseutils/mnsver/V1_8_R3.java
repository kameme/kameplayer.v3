...
public class V1_8_R3 extends Vx_x_Rx {
	public void sendPacket(Player player, String packet, float x, float y, float z, float x2, float y2, float z2, float speed, int amount) {
		String[] str = packet.split("_");
		EnumParticle particle = get(str[0]);
		PacketPlayOutWorldParticles pac = new PacketPlayOutWorldParticles(particle, true, x, y, z, x2, y2, z2, speed, amount, a(str));
	...
	public void copyBlockCommandNBT(org.bukkit.block.Block b, byte power) {
		...
		CommandBlockListenerAbstract cb = ((TileEntityCommand) world.getTileEntity(pos)).getCommandBlock();
